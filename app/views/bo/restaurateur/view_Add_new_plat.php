...
<div style="max-width: 600px; padding: auto; margin: auto;">
    <form role="form" class="form-horizontal" action="<?= DIR ?>restaurateur/plates/addnew" method="POST">
        <fieldset>
            <!-- Form Name -->
            <legend><?= ADD_NEW_PLAT_TO_MENU ?> : <?= $menu_name ?></legend>
            <input type="hidden" id="idMenu" name="idMenu" value="<?= $menu[0]->idMenu ?>">
            <!-- Text input-->
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <div class="input-group">
                        <input id="txtPrix" name="txtPrix" type="text" class="form-control">
