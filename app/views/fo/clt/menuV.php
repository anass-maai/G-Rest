    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <!-- <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            <li><a href="<?= DIR ?>user/newResrtorant"><?= BO_NAV_ADD_RESTAURANT ?></a></li>
            <li><a href="<?= DIR ?>resrtorant/list"><?= BO_NAV_List_RESTAURANTS ?></a></li>
            <!-- <li class="divider"></li> -- >
          </ul>
        </li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            <li><a href="<?= DIR ?>user/newRestaurateur"><?= BO_NAV_ADD_RESTAURATEUR ?></a></li>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu">
            <li><a href="<?= DIR ?>user/userInfo"><?=BO_NAV_MY_ACCOUNT_VIEW ?></a></li>
            <li class="divider"></li>
