...
class An_Paginator{
	...
	*/
	 ...
	 * @param URL      $path sets the URL to the target webpage  (ex: myWebSite/targetPage)
     * @param numeric  $page sets the table page we want to display
	 */
	public function __construct($path,$perPage,$page){
		$this->_instance = $page;
	...
	*/
	private function set_instance(){
		$this->_page = (int) (!isset($this->_instance) ? 1 : $this->_instance);
